...
public class login extends javax.swing.JFrame {
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        String sql = "select * from personas where nombre=? and pass=? and tipo='admin'";
        try{
            ...
            if(rs.next()){
                ...
                mst.setVisible(true);
                mst.setLocationRelativeTo(mst);
                this.dispose();
            }else{
                JOptionPane.showMessageDialog(null, "Incorrecto el nombre de usuario o contrasena: " + username.getText() + txtpass.getText() + JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception e){}
